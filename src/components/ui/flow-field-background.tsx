...
export default function NeuralBackground({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.fillStyle = `rgba(243, 246, 255, ${trailOpacity})`; 
  ...
  return (
    <div ref={containerRef} className={cn("absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0 opacity-75", className)}>
